 ...
 */
package org.apache.beam.runners.kstream.examples;
...
/**
 * Windowed word count example on Kafka Streams runner.
 */
public class WordCountTest extends AbstractIntegrationTest {
   ...
   */
  public interface WordCountOptions extends KafkaStreamsPipelineOptions {
  ...
  public void testWindowedWordCount() throws Exception {
    STREAMS_CONFIG.put(StreamsConfig.APPLICATION_ID_CONFIG, appID + "-windowed");
    ...
    while (System.currentTimeMillis() < timeout) {
      ...
      result.waitUntilFinish(Duration.millis(20000));
    }
    Assert.assertTrue(
