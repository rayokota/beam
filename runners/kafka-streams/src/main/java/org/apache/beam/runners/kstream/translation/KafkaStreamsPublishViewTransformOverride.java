...
/**
 * Kafka Streams override for {@link View} (side input) transforms.
 */
class KafkaStreamsPublishViewTransformOverride<ElemT, ViewT>
  ...
  public PTransformReplacement<PCollection<ElemT>, PCollection<ElemT>> getReplacementTransform(
    ...
    return PTransformReplacement.of(
        input,
        new KafkaStreamsCreatePCollectionViewTransform<>(transform.getTransform().getView())
    );
  }

  private static class KafkaStreamsCreatePCollectionViewTransform<ElemT, ViewT>
      extends PTransform<PCollection<ElemT>, PCollection<ElemT>> {
    private final PCollectionView<ViewT> view;

    public KafkaStreamsCreatePCollectionViewTransform(PCollectionView<ViewT> view) {
      this.view = view;
    }
    ...
    public PCollection<ElemT> expand(PCollection<ElemT> input) {
      ...
      input
          ...
          .apply(new KafkaStreamsPublishView<>(view));
      return input;
    }
  }
