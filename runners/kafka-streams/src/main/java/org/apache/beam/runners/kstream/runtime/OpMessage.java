...
public class OpMessage<T> {
   ...
   * <li>CONTROL - a control message
   * </ul>
   */
  public enum Type {
    ELEMENT, SIDE_INPUT, CONTROL
  }
  ...
  public static <T> OpMessage<T> ofControl(ControlMessage<T> controlMessage) {
    return new OpMessage<>(Type.CONTROL, controlMessage, null, null);
  }
  ...
  public ControlMessage<T> getControlMessage() {
    ensureType(Type.CONTROL, "getControl");
    return (ControlMessage<T>) element;
  }
