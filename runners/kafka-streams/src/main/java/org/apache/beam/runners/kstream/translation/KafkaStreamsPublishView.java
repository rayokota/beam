...
/**
 * Kafka Streams {@link PTransform} that creates a primitive output {@link PCollection}, as the results
 * of a {@link PCollectionView}.
 */
class KafkaStreamsPublishView<ElemT, ViewT>
    extends PTransform<PCollection<List<ElemT>>, PCollection<List<ElemT>>> {
  private final PCollectionView<ViewT> view;

  KafkaStreamsPublishView(PCollectionView<ViewT> view) {
    this.view = view;
  }
