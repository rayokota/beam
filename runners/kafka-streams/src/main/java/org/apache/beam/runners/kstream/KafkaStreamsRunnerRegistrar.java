 ...
 * {@link KafkaStreamsRunner}.
 * <p>
 * {@link AutoService} will register Kafka Stream's implementations of the {@link PipelineRunner}
...
public class KafkaStreamsRunnerRegistrar {
  ...
  /**
   * Registers the {@link KafkaStreamsRunner}.
   */
  ...
  /**
   * Registers the {@link KafkaStreamsPipelineOptions}.
   */
